...
SWIFT_MODULE_NAMESPACE_PUSH("AdBrixRM")
...
SWIFT_CLASS("_TtC8AdBrixRM15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(AdBrixRM)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AdBrixRM)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AdBrixRM)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AdBrixRM)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AdBrixRM)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC8AdBrixRM12TaskDelegate")
