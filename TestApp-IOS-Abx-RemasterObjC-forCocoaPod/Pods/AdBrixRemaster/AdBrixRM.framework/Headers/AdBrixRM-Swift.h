...
enum AdBrixInviteChannel : NSInteger;
...
/// common 친구초대
- (void)commonInviteWithChannel:(enum AdBrixInviteChannel)channel eventDateMs:(double)eventDateMs;
/// common 친구초대
...
/// 커머스 공유 채널
typedef SWIFT_ENUM(NSInteger, AdBrixSharingChannel, closed) {
...
/// 회원가입 유형
typedef SWIFT_ENUM(NSInteger, AdBrixSignUpChannel, closed) {
...
/// 초대 유형
typedef SWIFT_ENUM(NSInteger, AdBrixInviteChannel, closed) {
  AdBrixInviteChannelAdBrixInviteKakaoChannel = 1,
  AdBrixInviteChannelAdBrixInviteNaverChannel = 2,
  AdBrixInviteChannelAdBrixInviteLineChannel = 3,
...
/// 커머스 결제 통화
typedef SWIFT_ENUM(NSInteger, AdBrixCurrencyType, closed) {
...
/// 커머스 결제 수단
typedef SWIFT_ENUM(NSInteger, AdbrixPaymentMethod, closed) {
